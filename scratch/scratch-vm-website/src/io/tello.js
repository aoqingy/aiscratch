...
class TELLO extends JSONRPC {

    /**
     * A TELLO peripheral socket object.  It handles connecting, over web sockets, to
     * TELLO peripherals, and reading and writing data to them.
    ...
    constructor (runtime, extensionId, peripheralOptions, connectCallback, resetCallback, messageCallback) {
        console.log('Entering TELLO()...');
        super();

        this._socket = runtime.getScratchLinkSocket('TELLO');
