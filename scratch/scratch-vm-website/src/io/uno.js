...
class UNO extends JSONRPC {

    /**
     * A UNO peripheral socket object.  It handles connecting, over web sockets, to
     * UNO peripherals, and reading and writing data to them.
    ...
    constructor (runtime, extensionId, peripheralOptions, connectCallback, resetCallback, messageCallback) {
        ...
        this._socket = runtime.getScratchLinkSocket('UNO');
