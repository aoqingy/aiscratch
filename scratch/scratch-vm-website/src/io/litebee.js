...
class LITEBEE extends JSONRPC {

    /**
     * A LITEBEE peripheral socket object.  It handles connecting, over web sockets, to
     * LITEBEE peripherals, and reading and writing data to them.
    ...
    constructor (runtime, extensionId, peripheralOptions, connectCallback, resetCallback, messageCallback) {
        console.log('Entering LITEBEE()...');
        super();

        this._socket = runtime.getScratchLinkSocket('LITEBEE');
    ...
    didReceiveCall (method, params) {
        ...
        console.log('Entering didReceiveCall...');
        console.log(method);
        switch (method) {
