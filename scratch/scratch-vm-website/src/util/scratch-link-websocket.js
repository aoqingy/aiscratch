...
class ScratchLinkWebSocket {
    ...
    open () {
        switch (this._type) {
        case 'BLE':
            this._ws = new WebSocket('wss://device-manager.aiscratch.online:20110/scratch/ble');	//aoqingy
            break;
        case 'BT':
            this._ws = new WebSocket('wss://device-manager.aiscratch.online:20110/scratch/bt');		//aoqingy
            break;
        case 'UNO':
            this._ws = new WebSocket('wss://device-manager.aiscratch.online:20110/scratch/uno');	//aoqingy
            break;
        case 'CUBIC':
